...
var Graddes = exports.Graddes = (function () {
    ...
    _createClass(Graddes, {
        fit: {
            value: function fit() {
                var iters = arguments[0] === undefined ? 1000 : arguments[0];
                ...
                while (!converge) {
                    ...
                    var theta0_new = subtract(theta0, multiply(grad0, lrate));
                    var theta1_new = subtract(theta1, multiplt(grad1, lrate));

                    var cost = Cost(total, theta0);
